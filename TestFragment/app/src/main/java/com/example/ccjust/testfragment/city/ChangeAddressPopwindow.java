package com.example.ccjust.testfragment.city;
...
import com.example.ccjust.testfragment.cityadapter.AbstractWheelTextAdapter1;
...
public class ChangeAddressPopwindow extends PopupWindow implements View.OnClickListener {
	...
	private String strProvince = "江苏";
	private String strCity = "南京";
	private String strArea = "鼓楼";
