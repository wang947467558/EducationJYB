package com.example.ccjust.testfragment.rili;
...
public class DateAdapter extends BaseAdapter {
    ...
    public DateAdapter(Context context, Resources res, int year_c, int month_c, int week_c,int week_num, int default_postion) {
        this();
        this.context = context;
        this.res = res;
        this.default_postion = default_postion;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (clickTemp == position) {
            ...
            tvCalendar.setOnClickListener(new Mylistener(position));
        } else {
